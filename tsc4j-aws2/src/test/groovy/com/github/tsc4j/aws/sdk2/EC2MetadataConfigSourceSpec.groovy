...
import static com.github.tsc4j.aws.sdk2.EC2MetadataConfigSource.DEFAULT_CFG_PATH
...
class EC2MetadataConfigSourceSpec extends Specification {
    ...
    def configureEc2MetadataEndpoint() {
        System.setProperty(SdkSystemSetting.AWS_EC2_METADATA_SERVICE_ENDPOINT.property(), ec2MockEndpoint)
    }
    ...
    def "should create valid e2 metadata config source builder"() {
        ...
        impl << [
            ...
            "com.github.tsc4j.aws.sdk2.EC2MetadataConfigSource"
        ]
    }
